...
const ContentManagement = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const aboutResponse = await fetch('https://carboncube-ke-rails-cu22.onrender.com/admin/abouts', {
                    headers: {
                        'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                    },
                });
                const faqsResponse = await fetch('https://carboncube-ke-rails-cu22.onrender.com/admin/faqs', {
                    headers: {
                        'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                    },
                });
                const bannersResponse = await fetch('https://carboncube-ke-rails-cu22.onrender.com/admin/banners', {
                    headers: {
                        'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                    },
                });
    ...
    const handleSaveChanges = async () => {
        try {
            ...
            const url = `https://carboncube-ke-rails-cu22.onrender.com/admin/${type}/${data.id}`;
    ...
    const handleDeleteFaq = async (faqId) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-cu22.onrender.com/admin/faqs/${faqId}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
    ...
    const handleUploadBanner = async () => {
        ...
        try {
            ...
            const response = await fetch('https://carboncube-ke-rails-cu22.onrender.com/admin/banners', {
                method: 'POST',
                headers: {
                'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
    ...
    const handleDeleteBanner = async (id) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-cu22.onrender.com/admin/banners/${id}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
