...
const AdsManagement = () => {
    ...
    const fetchAds = async () => {
        try {
            const response = await fetch('http://carboncube-backend:3001/admin/ads', {
                headers: {
    ...
    const handleViewDetailsClick = async (ad) => {
        try {
            const response = await fetch(`http://carboncube-backend:3001/admin/ads/${ad.id}`, {
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
            });
    ...
    const handleSendNotification = async () => {
        try {
            const response = await fetch(`http://carboncube-backend:3001/admin/ads/${selectedAd.id}/notify`, {
                method: 'POST',
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
    ...
    const handleFlagAd = async (id) => {
        try {
            const response = await fetch(`http://carboncube-backend:3001/admin/ads/${id}/flag`, {
                method: 'PATCH',
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
    ...
    const handleRestoreAd = async (id) => {
        try {
            const response = await fetch(`http://carboncube-backend:3001/admin/ads/${id}/restore`, {
                method: 'PATCH',
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
