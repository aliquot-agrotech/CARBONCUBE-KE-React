...
const ProductsManagement = () => {
    ...
    const fetchProducts = async () => {
        try {
            const response = await fetch('https://carboncube-ke-rails-4xo3.onrender.com/admin/products', {
                headers: {
    ...
    const handleViewDetailsClick = async (product) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-4xo3.onrender.com/admin/products/${product.id}`, {
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
            });
    ...
    const handleSendNotification = async () => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-4xo3.onrender.com/admin/products/${selectedProduct.id}/notify`, {
                method: 'POST',
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
    ...
    const handleFlagProduct = async (id) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-4xo3.onrender.com/admin/products/${id}/flag`, {
                method: 'PATCH',
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
    ...
    const handleRestoreProduct = async (id) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-4xo3.onrender.com/admin/products/${id}/restore`, {
                method: 'PATCH',
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
