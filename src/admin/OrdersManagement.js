...
const OrdersManagement = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                const response = await fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/orders?search_query=${searchQuery}`, {
                    headers: {
    ...
    const handleRowClick = async (orderId) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/orders/${orderId}`, {
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
            });
    ...
    const handleUpdateStatus = async (orderId, status) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/orders/${orderId}/update-status`, {
                method: 'PUT',
                headers: {
