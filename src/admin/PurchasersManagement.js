...
const PurchasersManagement = () => {
  ...
  useEffect(() => {
      const fetchPurchasers = async () => {
          try {
              const response = await fetch(`https://carboncube-ke-rails-4xo3.onrender.com/admin/purchasers?search_query=${searchQuery}`, {
                  headers: {
  ...
  const handleRowClick = async (purchaserId) => {
    try {
      const response = await fetch(`https://carboncube-ke-rails-4xo3.onrender.com/admin/purchasers/${purchaserId}`, {
        headers: {
  ...
  const handleUpdateStatus = async (purchaserId, status) => {
    try {
      const response = await fetch(`https://carboncube-ke-rails-4xo3.onrender.com/admin/purchasers/${purchaserId}/${status}`, {
        method: 'PUT',
        headers: {
