...
const VendorsManagement = () => {
    ...
    useEffect(() => {
        const fetchVendors = async () => {
            try {
                const response = await fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/vendors?search_query=${searchQuery}`, {
                    headers: {
    ...
    const handleRowClick = async (vendorId) => {
        try {
            const [vendorResponse, ordersResponse, productsResponse, reviewsResponse] = await Promise.all([
                fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/vendors/${vendorId}`, {
                    headers: {
                        'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                    },
                }),
                fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/vendors/${vendorId}/orders`, {
                    headers: {
                        'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                    },
                }),
                fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/vendors/${vendorId}/products`, {
                    headers: {
                        'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                    },
                }),
                fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/vendors/${vendorId}/reviews`, {
                    headers: {
                        'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                    },
                })
    ...
    const handleUpdateStatus = async (vendorId, status) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/vendors/${vendorId}/${status}`, {
                method: 'PUT',
                headers: {
    ...
    const fetchVendorAnalytics = async (vendorId) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-7ty3.onrender.com/admin/vendors/${vendorId}/analytics`, {
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
            });
