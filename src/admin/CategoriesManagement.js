...
const CategoriesManagement = () => {
    ...
    const handleSaveCategory = async () => {
        ...
        const url = isEditing 
            ? `https://carboncube-ke-rails-7ty3.onrender.com/admin/categories/${selectedCategory.id}` 
            : 'https://carboncube-ke-rails-7ty3.onrender.com/admin/categories';
        ...
        try {
            ...
            for (const subcategory of newCategory.subcategories) {
                ...
                const subcategoryUrl = subcategory.id
                    ? `https://carboncube-ke-rails-7ty3.onrender.com/admin/subcategories/${subcategory.id}`
                    : `https://carboncube-ke-rails-7ty3.onrender.com/admin/subcategories`;
            ...
            for (const subcategoryId of subcategoriesToDelete) {
                const subcategoryUrl = `https://carboncube-ke-rails-7ty3.onrender.com/admin/subcategories/${subcategoryId}`;
