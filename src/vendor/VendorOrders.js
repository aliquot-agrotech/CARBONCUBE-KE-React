...
const VendorOrders = () => {
    ...
    useEffect(() => {
        const fetchOrders = async () => {
            try {
                const response = await fetch(`https://carboncube-ke-rails-qrvq.onrender.com/vendor/orders?vendor_id=${vendorId}&search_query=${searchQuery}`, {
                    headers: {
    ...
    const handleRowClick = async (orderId) => {
        try {
            const response = await fetch(`https://carboncube-ke-rails-qrvq.onrender.com/vendor/orders/${orderId}`, {
                headers: {
                    'Authorization': 'Bearer ' + sessionStorage.getItem('token'),
                },
            });
    ...
    //     try {
    //         const response = await fetch(`https://carboncube-ke-rails-qrvq.onrender.com/vendor/orders/${orderId}/update_status`, {
    //             method: 'PUT',
    //             headers: {
