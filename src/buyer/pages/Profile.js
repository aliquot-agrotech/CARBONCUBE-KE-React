...
const ProfilePage = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/buyer/profile`, {
        headers: {
    ...
    const handleSaveClick = () => {
        ...
        axios.put(`${process.env.REACT_APP_BACKEND_URL}/buyer/profile`, profile, {
        headers: {
            Authorization: `Bearer ${token}`
        }
        })
    ...
    const handlePasswordChange = () => {
        ...
        axios.post(`${process.env.REACT_APP_BACKEND_URL}/buyer/profile/change-password`, {
    ...
    const handleDeleteAccount = () => {
        ...
        setAlertModalConfig({
            ...
            onConfirm: async () => {
            try {
                await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/buyer/delete_account`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
                });
